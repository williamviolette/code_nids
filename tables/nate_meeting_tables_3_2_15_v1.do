...
*	outreg2 using clean/tables/main_spec_n1, nonotes tex(frag) keep(h_chi* h_chn*) label append nocons title("Main Specification")
	...
	* split small and large
	


	xi: reg zw_ch h_chi h_chn h_chi_at_7_18 h_chn_at_7_18  h_chi_at_60 h_chn_at_60 i.size_lag  at_sl_7_18  at_sl_60 at_7_18 at_60 sex i.r if size_lag<=5 & a<60, robust cluster(hh1)
	outreg2 using clean/tables/main_spec_n1, nonotes tex(frag) keep(h_chi* h_chn*) label replace nocons title("Main Specification: small and large")
