...
*	drop if h_ch==1 & own==0
	...
	xi: reg zhfa_ch h_ch h_ch_large m_ch m_ch_large large a sex   h_chS h_chML *_LARGE    i.r*i.prov  zhfa_p*  if  hclust>=$clust & im<=$im & a<$a & size_lag<$s & zhfa_ch<2 & zhfa_ch>-1.5 & size_lag>2, robust cluster(cluster)	
