...
program define expenditure_income
	...
	egen E_vice=rowtotal(h_nfalcspn h_nfcigspn h_nflot)
...
program define child_count_res
	...
	g c`r'_ressvy=(a_bhali`r'==1 & a_bhlive`r'==1 & a_bhdob_y`r'>=2002 & a_bhdob_y`r'<2009)
	g c`r'_nressvy=(a_bhali`r'==1 & a_bhlive`r'!=1 & a_bhdob_y`r'>=2002 & a_bhdob_y`r'<2009)
	}
	egen C_cr=rowtotal(*_resss)
	egen C_cn=rowtotal(*_nresss)
	egen C_cry=rowtotal(*_ressy)
	egen C_cny=rowtotal(*_nressy)
	egen C_crvy=rowtotal(*_ressvy)
	egen C_cnvy=rowtotal(*_nressvy)
end
