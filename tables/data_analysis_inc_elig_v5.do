...
*	duplicates drop hhid, force
	g inc_lg=inc_l+inc_g
	replace inc_lg=inc_l if inc_lg==. & inc_l!=.
	replace inc_lg=inc_g if inc_lg==. & inc_g!=.
	
	g il=.
	forvalues r=500(500)5000 {
	replace il=`r' if inc_l>=`r'-500 & inc_l<=`r'
	}
	egen h_chl_il=mean(h_chl), by(il)
	
	twoway scatter h_chl_il il
	graph export clean/tables/discontinuity.pdf, replace as(pdf)
	hist inc_l if rdp==0 & r<3 & inc_l<10000, by(h_chl) xtick(0(100)10000) xlabel(1500(2000)10000)
	graph export clean/tables/discontinuity_histogram.pdf, replace as(pdf)
	** HERE IS THE GRAPHS!
	...
	** informal settlement round 1
	 ...
	 ***** LOOK AT NEW 3500 CUT-OFF EMPIRICALLY
	
	g il=1 if inc_lr1<=3500
	replace il=0 if inc_lr1>3500 & inc_lr1<.
	g ilp=1 if inc_lr1<=2000
	replace ilp=0 if inc_lr1>2000 & inc_lr1<.
	g ilp1=1 if inc_lr1<=4000
	replace ilp1=0 if inc_lr1>4000 & inc_lr1<.
	g ilp2=1 if inc_lr1<=5000
	replace ilp2=0 if inc_lr1>5000 & inc_lr1<.
	g inc_lr1_id=inc_l if r==1
*	egen inc_lr1=max(inc_lr1_id), by(pid)
	
	** Placebo tests
	xi: reg h_chl i.il*inc_lr1 i.il*inc_lr1_2 i.r if inc_lr1<10000 & inc_lr1>500 & rdp==0, cluster(hh1) robust

	xi: reg h_chl i.ilp*inc_lr1 i.ilp*inc_lr1_2 i.r if inc_lr1<10000 & inc_lr1>500 & rdp==0, cluster(hh1) robust
	
	xi: reg h_chl i.ilp1*inc_lr1 i.ilp1*inc_lr1_2 i.r if inc_lr1<10000 & inc_lr1>500 & rdp==0, cluster(hh1) robust
	
	xi: reg h_chl i.ilp2*inc_lr1 i.ilp2*inc_lr1_2 i.r if inc_lr1<10000 & inc_lr1>500 & rdp==0, cluster(hh1) robust
	
	** Placebo tests
	xi: reg h_chl i.il*inc_lr1 inc i.r if inc_lr1<5000 & inc_lr1>2000, cluster(hh1) robust

	xi: reg h_chl i.ilp*inc_lr1 i.r if inc_lr1<8000 & inc_lr1>500, cluster(hh1) robust
	
	xi: reg h_chl i.ilp1*inc_lr1 i.r if inc_lr1<8000 & inc_lr1>500, cluster(hh1) robust
	
	xi: reg h_chl i.ilp2*inc_lr1  i.r if inc_lr1<8000 & inc_lr1>500, cluster(hh1) robust
	


	xi: reg zwfa i.il*inc_lr1 i.r if s2r1==0 & a<=7 & inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust
	xi: reg zwfa i.il*inc_lr1 i.r if s2r1==1 & a<=7 & inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust

	xi: reg zhfa i.il*inc_lr1 i.r if s2r1==0 & a<=7 & inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust
	xi: reg zhfa i.il*inc_lr1 i.r if s2r1==1 & a<=7 & inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust

	xi: reg rooms i.il*inc_lr1 i.r if inc_lr1<5000 & inc_lr1>2000 & r>1 & roomsr1<=3, cluster(hh1) robust
	xi: reg rooms i.il*inc_lr1 i.r if inc_lr1<5000 & inc_lr1>2000 & r>1 & roomsr1>3, cluster(hh1) robust

* UNCLUSTERED: we get a large reduction in size
	
	g rc=(h_chl==0 & rdp==1)
	
	g rdp_no_own=(rdp==1 & own==0)
	egen rdp_no_own_m=max(rdp_no_own), by(pid)
	drop if rdp_no_own_m==1
	
	global l_b "1500"
	global u_b "5000"
	
	foreach var of varlist h_ch own flush rooms piped {
	xi: reg `var' i.il*inc_lr1  i.r if inc_lr1<$u_b & inc_lr1>$l_b & r>1 & rc==0, cluster(hh1) robust
	}	
	

	xi: xtreg own rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust
	xi: xtreg flush rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust
	xi: xtreg rooms rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust
	xi: xtreg piped rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust


	
	xi: reg h_ch il inc i.r if inc_lr1<$u_b & inc_lr1>$l_b & r>1, cluster(hh1) robust	
	xi: reg own il inc i.r if inc_lr1<$u_b & inc_lr1>$l_b & r>1, cluster(hh1) robust
	xi: reg flush il i.r if inc_lr1<$u_b & inc_lr1>$l_b & r>1, cluster(hh1) robust
	xi: reg rooms il inc i.r if inc_lr1<$u_b & inc_lr1>$l_b & r>1, cluster(hh1) robust
	xi: reg piped il inc i.r if inc_lr1<$u_b & inc_lr1>$l_b & r>1, cluster(hh1) robust

	xi: xtreg size rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust
	xi: xtreg size rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==0, fe cluster(hh1) robust
	xi: xtreg size rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==1, fe cluster(hh1) robust

	xi: xtreg child rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==0, fe cluster(hh1) robust
	xi: xtreg child rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==1, fe cluster(hh1) robust
	xi: xtreg adult_men rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==0, fe cluster(hh1) robust
	xi: xtreg adult_men rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==1, fe cluster(hh1) robust
	xi: xtreg adult_women rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==0, fe cluster(hh1) robust
	xi: xtreg adult_women rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b & s2r1==1, fe cluster(hh1) robust
	
	xi: xtreg fd rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust
	xi: xtreg e rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust
	xi: xtreg ue rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust
	xi: xtreg c_ill rdp i.r if inc_lr1<$u_b & inc_lr1>$l_b, fe cluster(hh1) robust


	xi: reg own i.il*inc_lr1 i.r if inc_lr1<5000 & inc_lr1>2000 & r>1 & rc==0, cluster(hh1) robust

	xi: reg own i.il*inc_lr1 i.il*inc_lr1_2 i.r if inc_lr1<5000 & inc_lr1>2000 & r>1 & rc==0, cluster(hh1) robust

	g r2_4=(rooms>=2 & rooms<=4)

	xi: reg flush il inc i.r if inc_lr1<6000 & inc_lr1>1000 & r>1, cluster(hh1) robust


	xi: reg h_ch il inc i.r if inc_lr1<6000 & inc_lr1>1000 & r>1, cluster(hh1) robust
	
	xi: reg piped il inc i.r if inc_lr1<6000 & inc_lr1>1000 & r>1, cluster(hh1) robust
	
	xi: reg own il inc i.r if inc_lr1<6000 & inc_lr1>1000 & r>1, cluster(hh1) robust
	xi: reg h_ch il inc i.r if inc_lr1<5000 & inc_lr1>1000 & r>1, cluster(hh1) robust
	xi: reg house il inc i.r if inc_lr1<6000 & inc_lr1>1000 & r>1, cluster(hh1) robust
	xi: reg piped il inc i.r if inc_lr1<6000 & inc_lr1>1000 & r>1, cluster(hh1) robust
	
	xi: reg size il inc i.r if inc_lr1<6000 & inc_lr1>1000 & r>1, cluster(hh1) robust


	
	xi: reg rooms il inc i.r if inc_lr1<5000 & inc_lr1>1000 & r>1, cluster(hh1) robust
	xi: reg mktv il inc i.r if inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust
	
	
	
	xi: reg size il inc i.r if inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust


	
	tab own if inc_lr1<5000 & inc_lr1>2000 & r>1 & rc==0


	xi: reg size i.il*inc_lr1 inc i.r if inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust

	xi: reg child i.il*inc_lr1 inc i.r if inc_lr1<5000 & inc_lr1>2000 & r>1, cluster(hh1) robust
	
	xi: reg child i.il*inc_lr1 i.r if inc_lr1<5000 & inc_lr1>2000 & r>1 & rc==0, robust cluster(hh1)

* works unclustered.. 

	xi: reg child il inc_lr1 i.r if inc_lr1<5000 & inc_lr1>2000 & r>1 & rc==0, robust cluster(hh1)


	xi: reg piped i.il*inc_lr1 i.r if inc_lr1<7000 & inc_lr1>1000 & r>1 & rc==0, cluster(hh1) robust
	...
	xi: reg zhfa i.il*inc_lr1 i.r if s2r1==0 & a<=7, cluster(hh1) robust
	xi: reg zhfa i.il*inc_lr1 i.r if s2r1==1 & a<=7, cluster(hh1) robust
	...
	xi: reg h_chl i.il*inc_lr1 i.il*inc_lr1_2 i.r if inc_lr1>1000 & inc_lr1<5000 & rdp==0, cluster(hh1) robust
	
	xi: reg rdp i.il*inc_lr1 i.il*inc_lr1_2 i.r if inc_lr1>1000 & inc_lr1<5000, cluster(hh1) robust
	
	xi: reg h_chl i.il*inc_lr1 i.il*inc_lr1_2 i.r if inc_lr1>1000 & inc_lr1<5000, cluster(hh1) robust
	
	xi: reg h_chl i.il*inc_lr1 i.r if inc_lr1>2000 & inc_lr1<5000 & rdp==0, cluster(hh1) robust
	xi: reg h_chl i.il*inc_lr1 i.r if inc_lr1>2000 & inc_lr1<5000, cluster(hh1) robust
	xi: reg h_chl il i.il*inc_lr1 i.r if inc_lr1>2500 & inc_lr1<4500 & rdp==0, cluster(hh1) robust

	xi: reg h_chl i.il*inc_lr1 i.il*inc_lr1_2 i.r if inc_lr1>2500 & inc_lr1<4500 & rdp==0, cluster(hh1) robust
