...
program define left_out
	...
	g wag=fwag
	replace wag=fwag+cwag if cwag!=.
	replace wag=fwag+swag if swag!=.
	
	g wag_per=fwag/inc
	
	g own_d=(pid==h_ownpid1 | pid==h_ownpid2 | pid==h_ownpid3)
	
	tab noch if a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im
	tab size noch
	
	tab noch own_d if size>3 & size<12 & r<3 & a>18 & a<70 & (hch1==1 | hch2==1)   & im<=$im
	

	xi: xtreg e i.noch*i.s6 a sex if (hch1==1 | hch2==1) & size<12 & im<=$im, fe robust		
	
	xi: xtreg e noch a sex if a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, fe robust

	xi: xtreg a noch if a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, fe robust


	xi: xtreg ue i.noch*i.s6 i.r if a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, fe robust



	xi: reg noch own_d hoh a sex a_sex size i.r if  r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & size>4 & size<12 & im<=$im, cluster(cluster) robust
	xi: reg noch own_d hoh a sex a_sex size i.r if  r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & size>6 & size<12 & im<=$im, cluster(cluster) robust
	xi: reg noch own_d hoh a sex a_sex size i.r if  r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & size>4 & size<7 & im<=$im, cluster(cluster) robust


	xi: reg noch own_d hoh a sex a_sex size wag_per i.r if  r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & size>4 & size<12 & im<=$im, cluster(cluster) robust


	xi: reg noch i.hoh*i.s6 size a sex  i.r if  size>4 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust

	xi: reg noch i.s6*a size hoh sex  i.r if  size>4 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust

	replace cres=0 if sex==0 & a>18 & a<65 & cres==.
	replace cnres=0 if sex==0 & a>18 & a<65 & cnres==.
	

	
	tab cn noch if size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im
	
	tab cres noch if size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im
	
*^*	hist cres if size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, by( noch)
	
		*** INTERESTING SPECS ***
	xi: reg noch cres cn a size hoh sex a_sex dec  i.r if  size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust

	xi: reg noch cr a size hoh sex a_sex  dec i.r if  size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust
	
		
	xi: xtreg cr noch a sex i.r if size>2 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, fe robust
	
	xi: xtreg cr noch a sex e i.r if size>2 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, fe robust
		
	

	xi: reg noch cres a size hoh sex  i.r if  size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust

	xi: reg noch cnres a size hoh sex  i.r if  size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust
	
	xi: reg noch cres cnres a size hoh sex  i.r if  size>3 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust



	xi: reg noch i.e*i.s6 size a sex  i.r if  size>4 & size<12 & r<3 & a>18 & a<65 & (hch1==1 | hch2==1)   & im<=$im, cluster(cluster) robust


	xi: reg noch i.hoh*i.s6 i.e*i.s6 a sex size i.r if size>3 & size<12 &  r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & im<=$im, cluster(cluster) robust



	xi: reg noch e hoh a sex size i.r if r<3 & a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, cluster(cluster) robust



	xi: reg noch hoh a sex size s6 i.r if a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, cluster(cluster) robust

	xi: reg  hoh a sex size i.noch*i.s6 i.r if a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, cluster(cluster) robust

		

	xi: xtreg  hoh a sex i.noch*i.s6 i.r if a>18 & a<65 & (hch1==1 | hch2==1) & size<12 & im<=$im, fe robust
			
	
	xi: xtreg sex noch a, fe robust
	
	hist size if size<12, by(noch)
...
program define health_overall 
	...
	outreg2 using clean/tables/health_overall, nonotes tex(frag) keep(h_ch h_chS) label replace sortvar(h_ch h_ch_large h_chS h_chS_large large) nocons  addtext(Treated Area, Full Sample)	
	global clust "5"
	xi: reg zhfa_ch h_ch m_ch lo lo_large a sex h_chS h_chML    i.r*i.prov zhfa_p*  if  hclust>=$clust & im<=3500 & a<$s & size_lag<$s & zhfa_ch<2 & zhfa_ch>-1.3 & size_lag>2, robust cluster(cluster)	
	outreg2 using clean/tables/health_overall, nonotes tex(frag) keep(h_ch h_chS) label append sortvar(h_ch h_ch_large h_chS h_chS_large large) nocons  addtext(Treated Area, Over $clust)	
	global clust "0"
	...
	outreg2 using clean/tables/health_overall, nonotes tex(frag) keep(h_ch h_chS) label append nocons  addtext(Treated Area, Full Sample)	
	global clust "5"
	xi: reg zwfa_ch  h_ch m_ch lo lo_large h_chS h_chML    i.r*i.prov zwfa_p*  if  hclust>=$clust & im<=3500 & a<$a & size_lag<$s & zwfa_ch<2.5 & zwfa_ch>-2.66 & size_lag>2, robust cluster(cluster)	
