...
*	drop if h_ch==1 & own==0
	...
	xi: reg zhfa_ch h_ch h_ch_large m_ch m_ch_large large a sex i.r*i.prov zhfa_p*  if  hclust>=$clust & im<=$im & a<$a & size_lag<$s & zhfa_ch<2 & zhfa_ch>-1.3 & size_lag>2, robust cluster(hh1)	
	...
	xi: reg zwfa_ch h_ch h_ch_large m_ch m_ch_large large  a sex i.r*i.prov zwfa_p*  if  hclust>=$clust & im<=$im & a<$a & size_lag<$s & zwfa_ch<2.5 & zwfa_ch>-2.66 & size_lag>2, robust cluster(hh1)	
