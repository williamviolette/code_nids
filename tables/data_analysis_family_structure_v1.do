...
program define working
	...
	********************************
	...
	foreach var of varlist zwfa zhfa c_ill {
	xi: xtreg `var' rdp i.r if s2r1==0 & a<=7 & (best_race==1 | best_race==2), fe robust cluster(hh1)
	xi: xtreg `var' rdp i.r if s2r1==1 & a<=7 & (best_race==1 | best_race==2), fe robust cluster(hh1)
	}
