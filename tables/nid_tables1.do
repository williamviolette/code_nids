...
program define core_regressions
	xtset pid
	quietly xi: xtreg zhfa rdp i.r if a<=12, cluster(hh1) fe robust
	outreg2 using clean/tables/core_hfa_v1, nonotes tex(frag) label replace keep(rdp) nocons addtext(Time Fixed Effects, YES, Individual Fixed Effects, YES) title("Child Health: Height for Age Z-Score") addnote("Includes Children under 12")
	quietly xi: xtreg zhfa rdp i.r if s2r1==0 & a<=12, cluster(hh1) fe robust
	...
	quietly xi: xtreg zhfa rdp i.r if s2r1==1 & a<=12, cluster(hh1) fe robust
	...
	quietly xi: xtreg zhfa rdp rdp_large i.r if a<=12, cluster(hh1) fe robust
	...
	quietly xi: xtreg zwfa rdp i.r if a<=12, cluster(hh1) fe robust
	outreg2 using clean/tables/core_wfa_v1, nonotes tex(frag) label replace keep(rdp) nocons addtext(Time Fixed Effects, YES, Individual Fixed Effects, YES) title("Child Health: Weight for Age Z-Score") addnote("Includes Children under 12")
	quietly xi: xtreg zwfa rdp i.r if s2r1==0 & a<=12, cluster(hh1) fe robust
	...
	quietly xi: xtreg zwfa rdp i.r if s2r1==1 & a<=12, cluster(hh1) fe robust
	...
	quietly xi: xtreg zwfa rdp rdp_large i.r if a<=12, cluster(hh1) fe robust
...
program define core_regressions_no_cluster
	xtset pid
	quietly xi: xtreg zhfa rdp i.r if a<=12,  fe robust
	outreg2 using clean/tables/core_hfa_v1, nonotes tex(frag) label replace keep(rdp) nocons addtext(Time Fixed Effects, YES, Individual Fixed Effects, YES) title("Child Health: Height for Age Z-Score") addnote("Includes Children under 12")
	quietly xi: xtreg zhfa rdp i.r if s2r1==0 & a<=12,  fe robust
	outreg2 using clean/tables/core_hfa_v1, nonotes tex(frag) label append   keep(rdp) nocons addtext(Baseline Household Size, Less than 4, Time Fixed Effects, YES, Individual Fixed Effects, YES)
	quietly xi: xtreg zhfa rdp i.r if s2r1==1 & a<=12,  fe robust
	outreg2 using clean/tables/core_hfa_v1, nonotes tex(frag) label append  keep(rdp) nocons addtext(Baseline Household Size, More than 4, Time Fixed Effects, YES, Individual Fixed Effects, YES)
	quietly xi: xtreg zhfa rdp rdp_large i.r if a<=12,  fe robust
	outreg2 using clean/tables/core_hfa_v1, nonotes tex(frag) label append keep(rdp rdp_large) nocons addtext( Time Fixed Effects, YES, Individual Fixed Effects, YES)
	
	quietly xi: xtreg zwfa rdp i.r if a<=12,  fe robust
	outreg2 using clean/tables/core_wfa_v1, nonotes tex(frag) label replace keep(rdp) nocons addtext(Time Fixed Effects, YES, Individual Fixed Effects, YES) title("Child Health: Weight for Age Z-Score") addnote("Includes Children under 12")
	quietly xi: xtreg zwfa rdp i.r if s2r1==0 & a<=12,  fe robust
	outreg2 using clean/tables/core_wfa_v1, nonotes tex(frag) label append keep(rdp) nocons addtext(Baseline Household Size, Less than 4, Time Fixed Effects, YES, Individual Fixed Effects, YES)
	quietly xi: xtreg zwfa rdp i.r if s2r1==1 & a<=12,  fe robust
	outreg2 using clean/tables/core_wfa_v1, nonotes tex(frag) label append keep(rdp) nocons addtext(Baseline Household Size, More than 4, Time Fixed Effects, YES, Individual Fixed Effects, YES)
	quietly xi: xtreg zwfa rdp rdp_large i.r if a<=12,  fe robust
	outreg2 using clean/tables/core_wfa_v1, nonotes tex(frag) label append keep(rdp rdp_large) nocons addtext( Time Fixed Effects, YES, Individual Fixed Effects, YES)
end
