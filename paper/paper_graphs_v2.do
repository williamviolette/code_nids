...
outreg2 using paper/reduced_form_v2, nonotes tex(frag) label replace keep(rdp_np rdp_op) nocons addtext(Time Fixed Effects, YES, Individual Fixed Effects, YES, Maximum Age 11 to 15, YES) title("Education Impacts: Continued")
