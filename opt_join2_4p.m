...
% very simplified! but need substitution patterns to vary with n!!
 mf1=N1*(((c1/(N1))^alpha1)*((x1/(N1^k))^(alpha2+e))*(((h2/((N1+N2)^beta)))^(1-alpha1-alpha2)));
 mf2=N2*(((c2/(N2))^alpha1)*((x2/(N2^k))^(alpha2+e))*(((h2/((N1+N2)^beta)))^(1-alpha1-alpha2)));
