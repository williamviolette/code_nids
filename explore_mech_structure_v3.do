...
xi: xtreg c_ill i.rdp*g_hohr1 if u==1 & max_age<16, cluster(hh1) fe robust
xi: xtreg c_ill i.rdp*g_hohr1 if u==0 & max_age<16, cluster(hh1) fe robust

xi: xtreg c_ill i.rdp*g_hohr1 if u==1 & max_age<16, cluster(hh1) fe robust
xi: xtreg c_ill i.rdp*g_hohr1 if u==0 & max_age<16, cluster(hh1) fe robust


xi: xtreg c_ill i.rdp*p_hohr1 if u==1 & max_age<16, cluster(hh1) fe robust
xi: xtreg c_ill i.rdp*p_hohr1 if u==0 & max_age<16, cluster(hh1) fe robust

xi: xtreg z_weight i.rdp*p_hohr1 if u==1 & max_age<16 & z_weight>-5 & z_weight<5, cluster(hh1) fe robust
xi: xtreg z_weight i.rdp*p_hohr1 if u==0 & max_age<16 & z_weight>-5 & z_weight<5, cluster(hh1) fe robust

xi: xtreg c_health i.rdp*p_hohr1 if u==1 & max_age<16, cluster(hh1) fe robust
xi: xtreg c_health i.rdp*p_hohr1 if u==0 & max_age<16, cluster(hh1) fe robust
...
*** FIRST STAGE *** WITHOUT THE CONTROLS!!!!!!!!!!!!!!!!!!!!!!
xi: xtreg p_hoh rdp  if u==1 & max_age<16 & (prov==3 | prov==4 | prov==7 | prov==9) , cluster(hh1) fe robust
xi: xtreg p_hoh rdp  if u==0 & max_age<16 & (prov==3 | prov==4 | prov==7 | prov==9), cluster(hh1) fe robust
* only urban
...
forvalues r=1/9 {
xi: xtreg g_hoh rdp if u==1 & max_age<16 & prov==`r', cluster(hh1) fe robust
}
** THAT IS GOOD WE WANT THIS NEGATIVE

xi: xtreg g_hoh rdp if u==1 & max_age<16, cluster(hh1) fe robust
xi: xtreg g_hoh rdp if u==0 & max_age<16, cluster(hh1) fe robust

* only urban
xi: xtreg pg_hoh rdp if u==1 & max_age<16, cluster(hh1) fe robust
xi: xtreg pg_hoh rdp if u==0 & max_age<16, cluster(hh1) fe robust
* only urban
xi: xtreg m_f_res rdp i.r*i.prov if u==1 & max_age<16, cluster(hh1) fe robust
xi: xtreg m_f_res rdp i.r*i.prov if u==0 & max_age<16, cluster(hh1) fe robust
* only urban
