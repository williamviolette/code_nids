...
xi: xtreg e rdp left_in  left_out i.r*i.prov if a>18 & a<34, fe robust cluster(hh1)
xi: xtreg e rdp left_in  left_out i.r*i.prov if sex==1 & a>18 & a<34, fe robust cluster(hh1)
xi: xtreg e rdp left_in  left_out  i.r*i.prov if sex==0 &  a>18 & a<34, fe robust cluster(hh1)
xi: xtreg e rdp left_in  left_out  i.r*i.prov if u==1 &  a>18 & a<34, fe robust cluster(hh1)
xi: xtreg e rdp left_in  left_out i.r*i.prov if u==0 &  a>18 & a<34, fe robust cluster(hh1)
* relatively robust to age
...
xi: xtreg size_r rdp left_in  left_out i.r*i.prov, fe robust cluster(hh1)
** less than sort of an overcrowding!
