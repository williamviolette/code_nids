...
mf1=N1*(((c1/(N1+N2))^alpha1)*(h2/((N1+N2)^2))^(1-alpha1)+(((x1)^alpha2)*(h2)^(1-alpha2))^beta);
mf2=N2*(((c2/(N1+N2))^alpha1)*(h2/((N1+N2)^2))^(1-alpha1)+(((x2)^alpha2)*(h2)^(1-alpha2))^beta);
