...
g commute_dev_u_id=rdp_commute_u-commute_u

g commute_dev_u=(commute_dev_u_id>.11 & commute_dev_u_id<.)
replace commute_dev_u=. if commute_dev_u_id==.

xi: xtreg e rdp left_in  left_out i.r*i.prov if u==1 & commute_dev_u==1, fe robust cluster(hh1)
xi: xtreg e rdp left_in  left_out i.r*i.prov if u==1 & commute_dev_u==0, fe robust cluster(hh1)

** more pronounced when commute deviations are less..		
