...
g booze_exp=booze/exp_imp
g gamble_exp=gamble/exp_imp
...
*** CHECK OUT EXPENDITURE
g adults=size-children
g food_share=fexp_imp/exp_imp
...
xi: xtreg fexp_imp i.rdp*i.roomsr1 i.r*i.prov if u==1, fe robust cluster(hh1)
xi: xtreg exp_imp i.rdp*i.roomsr1 i.r*i.prov if u==1, fe robust cluster(hh1)

xi: xtreg gamble i.rdp*i.roomsr1 i.r*i.prov if u==1, fe robust cluster(hh1)
xi: xtreg booze_exp i.rdp*i.roomsr1 i.r*i.prov if u==1, fe robust cluster(hh1)
** SPEND LESS ON BOOZE!
xi: xtreg gamble_exp rdp i.r*i.prov if u==1, fe robust cluster(hh1)
** SPEND LESS ON GAMBLING!
...
xi: xtreg child_out i.rdp*i.roomsr1 i.r*i.prov if u==1, fe robust cluster(hh1)
xi: xtreg child_out i.rdp*i.roomsr1 i.r*i.prov if u==0, fe robust cluster(hh1)
...
xi: xtreg adults i.rdp*i.roomsr1 i.r*i.prov if u==1, fe robust cluster(hh1)
xi: xtreg adults i.rdp*i.roomsr1 i.r*i.prov if u==0, fe robust cluster(hh1)
